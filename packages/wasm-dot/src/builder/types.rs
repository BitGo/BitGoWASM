...
pub enum TransactionIntent {
    ...
    Transfer {
        ...
        to: String,
        /// Amount in planck (accepts JS BigInt natively via serde_wasm_bindgen)
        amount: u64,
    ...
    /// Stake (bond) DOT
    Stake {
        /// Amount to stake in planck (accepts JS BigInt natively)
        amount: u64,
...
pub struct BuildContext {
    ...
    /// Account nonce
    pub nonce: u32,
    /// Optional tip amount (in planck, accepts JS BigInt natively)
    #[serde(default)]
    pub tip: u64,
